...
public class DenseMatrix : Matrix
    ...
    public override Vector times(Vector B)
        {
        double thism = this.m;
        double thisn = this.n;
        ...
        if (thisn != B.m)
            throw new ExecutionEngineException("Matrix dimensions don't agree");
    ...
    public DenseMatrix solve (DenseMatrix B) 
        {
        if (this.m != this.n)
            throw new ExecutionEngineException("Attempting to solve non-square matrix");
    ...
    public override Vector times(Vector B, Vector C)
        {
        double thism = this.m;
        double thisn = this.n;
        double[] cvals = C.vals;
        ...
        if (thism != C.m)
            throw new ExecutionEngineException("Result vector wrong size");
    ...
    public override Vector transposeTimes(Vector B)
        {
        return transposeTimes(B, new Vector(this.m));
        }

    public override Vector transposeTimes(Vector B, Vector C)
        {
        double thism = this.m;
        double thisn = this.n;
    ...
    public override DiagonalMatrix getDiagonalMatrix()
        {
        if (this.m != this.n)
            throw new ExecutionEngineException("Matrix is not square");
    ...
    public DenseMatrix minus(DenseMatrix other)
        ...
        if (thism != other.m && thisn != other.n)
            throw new ExecutionEngineException("Matrix dimensions don't agreee");
    ...
    private class LUDecomposition 
        ...
        */
        ...
        /** Solve A*X = B
            ...
            @exception  ExecutionEngineException  Matrix is singular.
        */
        public DenseMatrix solve(DenseMatrix B) 
            {
            if (B.m != m)
            ...
            if (!this.isNonsingular())
                throw new ExecutionEngineException("Matrix is singular.");
