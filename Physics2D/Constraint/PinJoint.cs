...
namespace Physics2D.Constraint
{
     ...
     * velocities legal.
     */
    public class PinJoint : ForceConstraint, ImpulseConstraint
    {
        private Double2D r1;
        private Double2D r2;
        ...
        public PinJoint(Double2D pos, PhysicalObject2D obj1, PhysicalObject2D obj2)
        {
            ...
            // OBJ1
            double theta = obj1.GetOrientation()._radians;
            double cosTheta = Math.Cos(theta);
            double sinTheta = Math.Sin(theta);

            double[,] vals =
                new double[,] {{cosTheta, sinTheta},
                 {-sinTheta, cosTheta}};

            DenseMatrix rotInverse = new DenseMatrix(Array2D.GetArray(vals));
            ...
            // OBJ2
            theta = obj2.GetOrientation()._radians;
        ...
        {
            PhysicsState ps = PhysicsState.getInstance();
        ...
        {
            int DOF = PhysicsState.getInstance().numObjs();

            theta1 = obj1.GetOrientation()._radians;
            theta2 = obj2.GetOrientation()._radians;
        ...
        public void setCollisionMatrices(int curConstraintRow, BorderedDiagonalIdentityMatrix collisionMatrix, Vector answerVector)
        {
            ...
            // set
            int globalPosStart = obj1.getIndex() * 3;
            ...
            globalPosStart = obj2.getIndex() * 3;
        ...
        public void applyImpulses(int curAnswerRow, Vector answers)
        {
            ...
            Double2D r1 = this.r1.rotate(obj1.GetOrientation()._radians);

            PhysicalObject2D obj2 = this.obj2;
            Double2D r2 = this.r2.rotate(obj2.GetOrientation()._radians);
