...
public class BorderedDiagonalIdentityMatrix : Matrix
    {
    public double[] vals;
    ...
    public void setBlock(int rowoffset, int coloffset, double[][] vals)
        ...
        if (rowoffset < m - borderRows && coloffset < m - borderRows)
            throw new ExecutionEngineException("Can't put a block in the diagonal part of the matrix");
    ...
    public override Vector times(Vector other)
        {
        return times(other, new Vector(this.m));
        }

    public override Vector times(Vector other, Vector C)
        {
        C.clear();
        if (this.m != other.m)
            throw new ExecutionEngineException("Inner dimensions must agree");
    ...
    public override Vector transposeTimes(Vector other)
        {
        return transposeTimes(other, new Vector(this.m));
        }
        
    public override Vector transposeTimes(Vector other, Vector C)
        {
        C.clear();
        if (this.m != other.m)
            throw new ExecutionEngineException("Inner dimensions must agree");
